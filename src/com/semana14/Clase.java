...
public class Clase {
    ...
    public void imprimirDatosProfesor() {
        System.out.println("Profesor de la clase " + nombreMateria + ":");
    ...
    public void imprimirInfo(){
        System.out.println("Nombre de la Clase: "+nombreMateria);
    ...
    public void imprimirIntegrantes(){
        System.out.println("Profesor de la clase: " + getProfesor().getNombre() + " " + getProfesor().getApellidos());
